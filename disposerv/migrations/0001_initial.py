# Generated by Django 4.1.10 on 2023-08-24 10:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('genericposition_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='disposerv.genericposition')),
            ],
            bases=('disposerv.genericposition',),
        ),
        migrations.CreateModel(
            name='PositionAddress',
            fields=[
                ('genericaddress_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='disposerv.genericaddress')),
            ],
            bases=('disposerv.genericaddress',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            model_name='genericposition',
            index=models.Index(fields=['start_time'], name='disposerv_g_start_t_c65406_idx'),
        ),
        migrations.AddField(
            model_name='dispo',
            name='position',
